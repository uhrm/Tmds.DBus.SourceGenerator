                                                    ...
                                                    EqualsValueClause(
                                                        InvocationExpression(
                                                            ...
                                                            .AddArgumentListArguments(
                                                                Argument(
                                                                    MakeMemberAccessExpression("Tmds.DBus.Protocol.DBusType", Enum.GetName(typeof(DBusType), dBusValue.InnerDBusTypes[0].DBusType)!))))))),
                                WhileStatement(
                                    InvocationExpression(
                ...
                MethodDeclaration(
                    ...
                    .AddParameterListParameters(
                        Parameter(Identifier("writer"))
                            .WithType(IdentifierName("Tmds.DBus.Protocol.MessageWriter"))
                    ...
                    .WithBody(
                        Block()
                            .AddStatements(
                                LocalDeclarationStatement(
                                    VariableDeclaration(IdentifierName("Tmds.DBus.Protocol.ArrayStart"))
                                        .AddVariables(
